        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <div className="max-h-[70vh] overflow-y-auto p-1 pr-4 space-y-6">
                      ...
                      <div className="md:col-span-2 space-y-2">
                         <p className="font-medium text-sm">Housing</p>
                          ...
                          <div className="flex items-center space-x-2 pt-2">
                            ...
                            <label htmlFor="create-cage" className="text-sm font-medium leading-none">Create a new cage for this bird</label>
                          </div>
                      </div>
                  </div>
              </div>
              ...
              {/* Media Section */}
              <div className="space-y-4">
                  <h3 className="text-lg font-semibold tracking-tight">Image</h3>
                  <FormField
                    control={form.control}
                    name="imageUrl"
                    render={({ field }) => (
              ...
              {/* Genetics Section */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold tracking-tight">Genetics</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold tracking-tight">Relationships</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Financials Section */}
              <div className="space-y-4">
                  <h3 className="text-lg font-semibold tracking-tight">Financials</h3>
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
