  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li><strong>Data From You:</strong> All data you input into the application, including but not limited to bird details, cage details, financial transactions, notes, and breeding records, is stored on our servers.</li>
      </ul>
      ...
      <p>We do not share your information with any third parties, except as necessary to provide you with the Application services (e.g., payment processors, cloud hosting providers).</p>
      ...
      <div style={{ marginTop: '2rem', paddingTop: '1rem', borderTop: '1px solid #ccc' }}>
        <p><em><strong>Disclaimer:</strong> This is a boilerplate Privacy Policy and may not be sufficient for your specific needs. It is highly recommended that you consult with a legal professional to ensure compliance with all applicable laws and regulations.</em></p>
      </div>
    </div>
  );
}
